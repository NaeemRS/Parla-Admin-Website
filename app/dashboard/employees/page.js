  ...
  return (
    <>
      <Header
        ...
        buttonLabel={t('header.addEmployee')}
            ...
            <div className='md:p-5 mt-5 p-2'>
              ...
              <div className='mt-5'>
                <DataTable
                  ...
                  data={filteredOfficesData} // ✅ Now using filtered data!
              ...
              {/* Show message when no data found for selected letter */}
              {filteredOfficesData.length === 0 && selectedLetter && (
                <div className="text-center py-12 text-gray-500">
                  <p className="text-lg font-medium">No Employee found</p>
                  <p className="text-sm mt-1">No Employee start with the letter "{selectedLetter}"</p>
                  <button
                    onClick={handleShowAll}
                    className="mt-3 px-4 py-2 bg-[#FF6B00] text-white rounded h transition-colors"
